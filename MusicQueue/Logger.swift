...
protocol CustomLoggerProtocol {
    func debug(_ message: String, includeStackTrace: Bool)
    func error(_ message: String, includeStackTrace: Bool)
    func fault(_ message: String, includeStackTrace: Bool)
}
