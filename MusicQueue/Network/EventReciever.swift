...
//                NotificationCenter.default.post(name: .sessionCreatedNotification, object: true)
//            } else if let errResponse = firstItem["error"] as? String {
//                let error = EventError(message: errResponse)
//                NotificationCenter.default.post(name: .sessionCreatedNotification, object: error)
...
//            let serializationError = SerializationError(message: "Unable to deserialize response", stacktrace: Thread.callStackSymbols)
//
//                NotificationCenter.default.post(name: .songAddedNotification, object: serializationError)
//            return
//        }
//        
//        do {
...
//                        NotificationCenter.default.post(name: .songAddedNotification, object: resolvedSong)
//                    case .failure(let error):
//                        let resolutionError = SongResolutionError(message: "Cannot resolve song \(song). Error \(error)", stacktrace: Thread.callStackSymbols)
//                        NotificationCenter.default.post(name: .songAddedNotification, object: resolutionError)
//                    }
//                }
//            }
//        } catch let error as SongConversionError {
//            NotificationCenter.default.post(name: .songAddedNotification, object: error)
//        } catch {
//            
//        }
//    }
